...
import { useNavigate } from 'react-router-dom';
 ...
 export const DashNavbar: React.FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 h-20 flex items-center justify-between p-4 px-10  bg-[#0F1629]/70 border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.4)] backdrop-blur-lg text-gray-300">
      <div className="flex items-center gap-3 ml-20">
        <span onClick={()=>navigate("/")}className="text-2xl font-bold hover:cursor-pointer">Mind-OS</span>
      </div>
