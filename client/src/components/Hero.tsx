       ...
       <div className='w-full lg:w-xl mx-auto mt-6 lg:mt-8 px-2'>
        ...
        <div className='mt-6 sm:mt-8 lg:mt-10'>
            <button
              ...
              className='px-5 py-2.5 sm:px-6 sm:py-3 bg-gradient-to-r from-blue-900 to-slate-600 text-white text-base sm:text-lg lg:text-xl font-bold rounded-xl sm:rounded-2xl transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-blue-500/25 transform hover:-translate-y-1 cursor-pointer'
            >
              Get Started
            </button>
        </div>
